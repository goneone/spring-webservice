...
public class PostsRepositoryTest {
	...
	/*
	 * @Test public void 게시글저장_불러오기() { //given postsRepository.save(Posts.builder()
	 * .title("테스트 게시글") .content("테스트 본문") .author("jojoldu@gmail.com") .build());
	 * 
	 * //when List<Posts> postsList = postsRepository.findAll();
	 * 
	 * //then Posts posts = postsList.get(0); assertThat(posts.getTitle(),
	 * is("테스트 게시글")); assertThat(posts.getContent(), is("테스트 본문")); }
	 */
